const rodilloData = {
        suave: {
            ...
            tiempos: [
                { emoji:'⏱️', label:'30s',  texto:'durante 30 segundos' },
        ...
        salvaje: {
            ...
            zonas: [
                ...
                { emoji:'🌟', label:'Cuello',     texto:'el cuello' },
                { emoji:'💪', label:'Pecho',      texto:'el pecho' },
                { emoji:'⬇️', label:'Espalda',    texto:'la espalda entera' },
            ],
            tiempos: [
                { emoji:'⏱️', label:'2min',           texto:'durante 2 minutos sin parar' },
